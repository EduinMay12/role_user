...
<head>
    ...
    <script ssrc="https://unpkg.com/scrollreveal@4.0.0/dist/scrollreveal.min.js"></script>
</head>
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                                <img class="header-logo-image" src="./solid/dist/images/feature-icon-02.svg" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">Laravel</h1>
                            ...
                            <div class="hero-cta"><a class="button button-primary" href="{{ asset('./home') }}">Entrar</a></div>
                        </div>
            ...
            <section class="cta section">
                <div class="container">
                    <div class="cta-inner section-inner">
                        <h3 class="section-title mt-0">Si eres estudiante del utp puedes crear tu cuenta con tu correro institucional.</h3>
                        <div class="cta-cta">
                            <a class="button button-primary button-wide-mobile" href="{{ asset('./register') }}">Crear cuenta</a>
                        </div>
                    </div>
                </div>
            </section>
